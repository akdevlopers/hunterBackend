...
export function BrowserDonutChart({ data = [] }) {
  ...
  return (
    <div className="bg-white dark:bg-slate-900 border border-slate-200/90 dark:border-slate-800 rounded-2xl p-5 shadow-sm space-y-4 flex flex-col justify-between">
      <div className="flex items-center gap-2">
        ...
        <div>
          <h3 className="text-base font-semibold text-slate-900 dark:text-slate-100">Browser Distribution</h3>
          <p className="text-xs text-slate-500">Client web engines</p>
        </div>
      </div>
